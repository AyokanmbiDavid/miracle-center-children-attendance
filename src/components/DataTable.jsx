              ...
              {displayData.length > 0 ? (
                displayData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex p-1 justify-end bg-gray-100/70 rounded-full gap-1">
                        {/* copy */}
                        <button 
                           onClick={() => copydetail(item)}
                          className="p-2 text-gray-700 rounded-full bg-gray-100 hover:bg-gray-400 hover:text-white transition-colors border border-transparent"
                          title="Edit Member"
                        >
                        ...
                        <button 
                          ...
                          className="p-2 text-blue-600 rounded-full bg-blue-100 hover:bg-blue-600 hover:text-white transition-colors border border-transparent"
                          title="Edit Member"
                        >
                          <Edit size={16}/>
                        </button>
                        ...
                        <button 
                          ...
                          className="p-2 text-red-600 rounded-full bg-red-100 hover:bg-red-600 hover:text-white transition-colors border border-transparent"
                          title="Delete Member"
                        >
                          <Trash2 size={16}/>
                        </button>
